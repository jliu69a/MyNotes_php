<?php
    ...
    $sql2 = "SELECT a.`id`, a.`title`, a.`type_id`, b.`name` AS 'type_name', a.`update_date`, a.`date_time`, a.`content` FROM `my_notes` a, `my_notes_type` b WHERE a.`type_id` = b.`id` ORDER BY a.`date_time` DESC;";
    $resultArray2 = array();
